...
# Log file: grpo_smoe_gsm8k_math_<timestamp>.log
LOG_DIR="$SCRIPT_DIR/logs"
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/grpo_smoe_midtrain_phase2_decay_30036_gsm8k_math_$(date +%Y%m%d_%H%M%S).log"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='smoe_midtrain_phase2_decay_30036' \
